...
import NaverMapSpaceMarker from './NaverMapSpaceMarker';
import SpaceMarkerContent from './SpaceMarkerContent';
        ...
        <>
          ...
          <Table style={{ marginBottom: 24 }}>
            <CellWrap>
              ...
              <ValueCell>{data?.company_name}</ValueCell>
            </CellWrap>
            <CellWrap>
              <LabelCell>
                주소 <EngName>Address.</EngName>
              </LabelCell>
              <ValueCell>{data?.address}</ValueCell>
            </CellWrap>
            <CellWrap>
              <LabelCell>
                대표자 <EngName>Arep.</EngName>
              </LabelCell>
              <ValueCell>{data?.company_ceo_name}</ValueCell>
            </CellWrap>
            <CellWrap>
              <LabelCell>
                전화번호 <EngName>Tel.</EngName>
              </LabelCell>
              <ValueCell>{data?.tel}</ValueCell>
            </CellWrap>
            <CellWrap>
              <LabelCell>
                팩스번호 <EngName>Fax.</EngName>
              </LabelCell>
              <ValueCell>{data?.fax}</ValueCell>
            </CellWrap>
          </Table>
          <Table>
            <NaverMap
